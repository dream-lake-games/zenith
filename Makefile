...
xcodebuild-simulator:
	IOS_TARGETS=x86_64-apple-ios xcodebuild -scheme zenith -configuration Debug -derivedDataPath build -destination "id=$(DEVICE)"

xcodebuild-iphone:
	IOS_TARGETS=aarch64-apple-ios xcodebuild -scheme zenith -configuration Debug -derivedDataPath build -arch arm64
